...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> ROCKY_DEEP_DIRT = registerSimpleBlock("rocky_deep_dirt", () -> new Block(AbstractBlock.Properties.of(Material.DIRT).randomTicks().strength(0.5F).sound(SoundType.GRAVEL)));
    public static final RegistryObject<Block> COBBLED_DEEP_DIRT = registerSimpleBlock("cobbled_deep_dirt", () -> new Block(AbstractBlock.Properties.of(Material.STONE).randomTicks().strength(0.6F).sound(SoundType.STONE)));
