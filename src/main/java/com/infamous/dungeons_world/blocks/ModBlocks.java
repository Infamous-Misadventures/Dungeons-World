...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> GRASSY_COARSE_DEEP_DIRT_PATH = registerBlock("grassy_coarse_deep_dirt_path", () -> new PathBlock(AbstractBlock.Properties.of(Material.GRASS, MaterialColor.DIRT).strength(0.5F).sound(SoundType.GRAVEL), GRASSY_COARSE_DEEP_DIRT.get(), DEEP_DIRT.get().getRegistryName()));
    ...
    public static final RegistryObject<Block> PILLAR_STONE_COLUMN = registerBlock("pillar_stone_column", () -> new RotatedPillarBlock(AbstractBlock.Properties.of(Material.STONE).requiresCorrectToolForDrops().strength(1.5F, 6.0F)));
