...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> DEEP_DIRT_PATH = registerPathBlock("deep_dirt_path", () -> new PathBlock(BlockBehaviour.Properties.of(Material.DIRT, MaterialColor.DIRT).strength(0.5F).sound(SoundType.GRAVEL), DEEP_DIRT.get(), DEEP_DIRT.get().getRegistryName()));
    ...
    public static final RegistryObject<Block> GRASSY_COARSE_DEEP_DIRT_PATH = registerBlock("grassy_coarse_deep_dirt_path", () -> new PathBlock(BlockBehaviour.Properties.of(Material.GRASS, MaterialColor.DIRT).strength(0.5F).sound(SoundType.GRAVEL), GRASSY_COARSE_DEEP_DIRT.get(), DEEP_DIRT.get().getRegistryName()));
    ...
    public static final RegistryObject<Block> PEBBLED_DEEP_DIRT_PATH = registerPathBlock("pebbled_deep_dirt_path", () -> new PathBlock(BlockBehaviour.Properties.of(Material.DIRT, MaterialColor.DIRT).strength(0.5F).sound(SoundType.GRAVEL), PEBBLED_DEEP_DIRT.get(), DEEP_DIRT.get().getRegistryName()));
    ...
    public static final RegistryObject<Block> COARSE_DEEP_DIRT_PATH = registerPathBlock("coarse_deep_dirt_path", () -> new PathBlock(BlockBehaviour.Properties.of(Material.DIRT).strength(0.5F).sound(SoundType.GRAVEL), COARSE_DEEP_DIRT.get(), DEEP_DIRT.get().getRegistryName()));
    ...
    public static final RegistryObject<Block> DEEP_STONE_TILES_PATH = registerPathBlock("deep_stone_tiles_path", () -> new DirtyPathBlock(BlockBehaviour.Properties.of(Material.STONE).requiresCorrectToolForDrops().strength(1.5F, 6.0F), STONE_TILES.getBlock().get(), DEEP_DIRT.get().getRegistryName(), Dirty.DirtLevel.UNAFFECTED));
    ...
    public static final RegistryObject<Block> DEEP_HIGH_DIRTY_STONE_TILES_PATH = registerPathBlock("deep_high_dirty_stone_tiles_path", () -> new DirtyPathBlock(BlockBehaviour.Properties.of(Material.STONE).requiresCorrectToolForDrops().strength(1.5F, 6.0F), HIGH_DIRTY_STONE_TILES.getBlock().get(), DEEP_DIRT.get().getRegistryName(), Dirty.DirtLevel.HIGH));
    ...
    public static final RegistryObject<Block> DEEP_DETAILED_STONE_TILES_PATH = registerPathBlock("deep_detailed_stone_tiles_path", () -> new DirtyPathBlock(BlockBehaviour.Properties.of(Material.STONE).requiresCorrectToolForDrops().strength(1.5F, 6.0F), DETAILED_STONE_TILES.getBlock().get(), DEEP_DIRT.get().getRegistryName(), Dirty.DirtLevel.UNAFFECTED));
    ...
    public static final RegistryObject<Block> DEEP_HIGH_DIRTY_DETAILED_STONE_TILES_PATH = registerPathBlock("deep_high_dirty_detailed_stone_tiles_path", () -> new DirtyPathBlock(BlockBehaviour.Properties.of(Material.STONE).requiresCorrectToolForDrops().strength(1.5F, 6.0F), HIGH_DIRTY_DETAILED_STONE_TILES.getBlock().get(), DEEP_DIRT.get().getRegistryName(), Dirty.DirtLevel.HIGH));
