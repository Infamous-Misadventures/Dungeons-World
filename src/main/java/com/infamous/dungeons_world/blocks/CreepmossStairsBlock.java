...
public class CreepmossStairsBlock  extends StairsBlock implements Creepmoss {
    private final Creepmoss.CreepmossLevel creepmossLevel;

    public CreepmossStairsBlock(Creepmoss.CreepmossLevel creepmossLevel, Supplier<BlockState> baseBlockState, AbstractBlock.Properties settings) {
